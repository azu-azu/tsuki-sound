...
public struct NaturalSoundPresets {
    ...
    public struct PleasantWarm {
        ...
        /// ローパスフィルタカットオフ周波数（柔らかさのため）
        public static let lowpassCutoff: Float = 2000.0
    }
    ...
    public struct PleasantCalm {
        ...
        /// リバーブWet/Dry
        public static let reverbWetDryMix: Float = 14.0

        /// ローパスフィルタカットオフ周波数
        public static let lowpassCutoff: Float = 1800.0
    }
    ...
    public struct PleasantDeep {
        ...
        /// リバーブWet/Dry
        public static let reverbWetDryMix: Float = 18.0

        /// ローパスフィルタカットオフ周波数
        public static let lowpassCutoff: Float = 2200.0
    }
    ...
    public struct PleasantDrone {
        ...
        /// リバーブWet/Dry
        public static let reverbWetDryMix: Float = 16.0
    ...
    public struct AmbientFocus {
        ...
        /// ローパスフィルタカットオフ周波数
        public static let lowpassCutoff: Float = 2500.0
    }
    ...
    public struct AmbientSleep {
        ...
        /// ローパスフィルタカットオフ周波数
        public static let lowpassCutoff: Float = 1400.0
    }
}
