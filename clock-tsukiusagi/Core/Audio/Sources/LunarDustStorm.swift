//
//  LunarDustStorm.swift
//  clock-tsukiusagi
//
//  Created by Claude Code on 2025-11-17.
//  月面の砂嵐音源（ピンクノイズ + 静止LFO）
//
...
/// 月面の砂嵐音源（簡略版：Notchフィルタは未実装）
public final class LunarDustStorm: AudioSource {
    ...
    public init(
        ...
        lfoFrequency: Double = 0.02,
        lfoDepth: Double = 0.05
    ) {
