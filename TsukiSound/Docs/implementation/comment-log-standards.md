...
This document defines the mandatory comment and debug log standards for Claude Code when working with the TsukiSound codebase. The core principle: **learning comes first, cleanup comes last**.
...
- `TsukiSound/Docs/_guide-error-resolution.md` — Error resolution process
