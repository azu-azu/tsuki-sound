...
1. **WindChime (癒しチャイム)**
   - ファイル: `TsukiSound/Core/Audio/Sources/WindChime.swift`
   - 特徴: ペンタトニックスケール、ランダムトリガー、ADSR エンベロープ

2. **TibetanBowl (チベタンボウル)**
   - ファイル: `TsukiSound/Core/Audio/Sources/TibetanBowl.swift`
   - 特徴: 倍音合成、ビブラート変調、5倍音構造

3. **OceanWaves (波の音)**
   - ファイル: `TsukiSound/Core/Audio/Sources/OceanWaves.swift`
   - 特徴: ホワイトノイズ、LFO音量変調、5秒周期の波

4. **CracklingFire (焚き火の音)**
   - ファイル: `TsukiSound/Core/Audio/Sources/CracklingFire.swift`
...
```swift
// TsukiSound/Core/Audio/Engine/LocalAudioEngine.swift
...
```swift
// TsukiSound/Core/Audio/AudioService.swift
...
```swift
// TsukiSound/Core/Audio/Presets/NaturalSoundPresets.swift
...
```bash
# 古いコミットから該当ファイルを確認
git show e51bc1a^:TsukiSound/Core/Audio/Sources/WindChime.swift
git show e51bc1a^:TsukiSound/Core/Audio/Sources/TibetanBowl.swift
git show e51bc1a^:TsukiSound/Core/Audio/Sources/OceanWaves.swift
git show e51bc1a^:TsukiSound/Core/Audio/Sources/CracklingFire.swift
```
...
```bash
# 変調コンポーネント
git show e51bc1a^:TsukiSound/Core/Audio/Modulation/EnvelopeGenerator.swift
git show e51bc1a^:TsukiSound/Core/Audio/Modulation/RandomTrigger.swift
git show e51bc1a^:TsukiSound/Core/Audio/Modulation/LFO.swift

# 基本音源
git show e51bc1a^:TsukiSound/Core/Audio/Sources/Oscillator.swift
git show e51bc1a^:TsukiSound/Core/Audio/Sources/MultiOscillator.swift
git show e51bc1a^:TsukiSound/Core/Audio/Sources/PulseGenerator.swift
git show e51bc1a^:TsukiSound/Core/Audio/Sources/BandpassNoise.swift
git show e51bc1a^:TsukiSound/Core/Audio/Sources/NoiseSource.swift
```
...
```swift
// TsukiSound/Core/Audio/Presets/AudioFilePresets.swift
