...
**ファイル**: `TsukiSound/Core/Audio/Presets/AudioFilePresets.swift`
...
🎵 Generating ambient audio for TsukiSound...
   ...
   Output: ../TsukiSound/Resources/Audio

1/4 Generating Pink Noise...
✓ Generated WAV: ../TsukiSound/Resources/Audio/pink_noise_60s.wav

2/4 Generating Ocean Waves...
✓ Generated WAV: ../TsukiSound/Resources/Audio/ocean_waves_60s.wav

3/4 Generating Rain Sound...
✓ Generated WAV: ../TsukiSound/Resources/Audio/rain_60s.wav

4/4 Generating Forest Ambience...
✓ Generated WAV: ../TsukiSound/Resources/Audio/forest_ambience_60s.wav
...
1. Xcode で `TsukiSound/Resources/Audio/` を開く
2. `.caf` ファイルを選択
3. "Target Membership" が `TsukiSound` になっていることを確認
